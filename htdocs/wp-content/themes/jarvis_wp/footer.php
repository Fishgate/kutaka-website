...
<?php if($smof_data['rnr_home_type']=="Video") { ?>
        ...
        <a id="rnr-background-video" class="rnr-video-player" data-property="{ videoURL : '<?php echo $smof_data['rnr_home_video_id']; ?>' , containment : '#home-background-video' , mute : <?php echo $smof_data['rnr_video_mute']; ?>, startAt : 0, stopAt : 0, opacity : 1, optimizeDisplay: true, autoPlay : true, vol: 100, showControls: false, loop: <?php echo $smof_data['rnr_enable_video_loop']; ?>}"></a>	            
 <?php } ?>
